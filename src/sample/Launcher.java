...
public class Launcher {
    ...
    public Launcher() {
        ...
        this.jf.setLocation(new Point((int)JFrame.CENTER_ALIGNMENT,(int)JFrame.CENTER_ALIGNMENT)); // this will open the window in the center of the screen.
    ...
    private void initUIComponents() {
        ...
        // this.walls = new WallsPopulator(); // create new walls populator
        //this.walls.gameInitialize();
